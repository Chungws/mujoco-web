...
│  │  - WidowX rankings (robot-specific)       │  │
│  │  - Global rankings                         │  │
...
**episodes** - episode_id, battle_id, turn_id, side, model_id, actions[], states[], metrics
...
- [ ] Update PostgreSQL models (Step 1)
- [ ] MongoDB connection (Step 2)
- [ ] Alembic migration (Step 3)
- [ ] Session API (POST /sessions/init)
- [ ] Models list API (GET /models)
...
- [ ] Turn API (POST /battles/{id}/turns)
- [ ] Episodes API (GET /episodes/{id})
